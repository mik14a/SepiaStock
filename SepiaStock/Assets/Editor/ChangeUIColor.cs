...
public class ChangeUIColor : EditorWindow
{
    ...
    Color _textColor = new(240 / 255f, 240 / 255f, 240 / 255f, 1);
    bool _foldoutButtonColor = true;
    Color _buttonColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _buttonHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _buttonPressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _buttonDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _buttonSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    bool _foldoutSliderColor = true;
    Color _sliderColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _sliderHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _sliderPressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _sliderDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _sliderFillColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _sliderSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    bool _foldoutToggleColor = true;
    Color _toggleColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _toggleHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _togglePressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _toggleDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _toggleSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    bool _foldoutDropdownColor = true;
    Color _dropdownColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _dropdownHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _dropdownPressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _dropdownDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _dropdownSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    bool _foldoutInputFieldColor = true;
    Color _inputFieldColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _inputFieldHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _inputFieldPressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _inputFieldDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _inputFieldSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    bool _foldoutScrollbarColor = true;
    Color _scrollbarColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    Color _scrollbarHighlightColor = new(180 / 255f, 105 / 255f, 255 / 255f, 1);
    Color _scrollbarPressedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _scrollbarDisabledColor = new(180 / 255f, 180 / 255f, 180 / 255f, 1);
    Color _scrollbarSelectedColor = new(255 / 255f, 105 / 255f, 180 / 255f, 1);
    Color _scrollbarImageColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
    bool _foldoutScrollRectColor = true;
    Color _scrollRectColor = new(51 / 255f, 51 / 255f, 51 / 255f, 1);
}
#endif
